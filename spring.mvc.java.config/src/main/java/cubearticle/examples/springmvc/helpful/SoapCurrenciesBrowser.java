	...
	public SoapCurrenciesBrowser() {
		...
		try {
			...
			StreamSource preppedMsgSrc = new StreamSource(new FileInputStream(
					"C:\\Users\\ѕолина\\git\\javaspring-project\\spring.mvc.java.config\\src\\main\\resources\\prepped.msg"));
			...
			String answer = out.toString();// кодировку сюда нормальную! при прописанной utf-8 пуста€ строка
			// в принципе можно забить на уехавшие русские символы и брать значени€ VEngname
